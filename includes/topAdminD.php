		<html>
			...
			<body>
				<table  width="100%" height="100%">
					<tr id="header">
						<td colspan="2">
								<a class="navbar-brand" href="adminD.php"><img src="../../img/books.png" width="38" height="38"></a>
                    ...
                    <a href="../../app/view/employeeList.php">Employee List</a>
                    <a href="../../app/view/addEmployee.php">Add Employee</a>
