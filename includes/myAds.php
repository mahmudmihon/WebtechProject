...
$user_id = $_SESSION['id'];
//$oldPublishedBooksList = 
//$oldUnpublishedBooksList = array();
$oldPublishedBooksList=loadOldPublishedBooksList($user_id);
$oldUnpublishedBooksList=loadOldUnpublishedBooksList($user_id);
//print_r($oldUnpublishedBooksList);
